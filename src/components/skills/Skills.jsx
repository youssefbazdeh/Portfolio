...
import springbootIcon from "../../assets/springboot_logo.png"
import kotlinIcon from "../../assets/Kotlin_Icon.png"
import swiftIcon from "../../assets/swift_icon.jpg"
        ...
        <div className="left flex-1 w-full">
          ...
          >
            <div className=" flex flex-col gap-6  w-3/4  my-5 md:w-[90%]">
              <ProgressBar
                  logo={<img src={flutterIcon} alt="Flutter Logo" className="w-6 h-6" />}
                  name={"Flutter"}
                  value={100}
                />
                <ProgressBar
                  logo={<img src={kotlinIcon} alt="Kotlin Logo" className="w-6 h-6" />}
                  name={"Kotlin/Android"}
                  value={70}
                />
                <ProgressBar
                  logo={<img src={swiftIcon} alt="Swift Logo" className="w-6 h-6" width={100} />}
                  name={"Swift/IOS"}
                  value={50}
                />
                <ProgressBar
                  logo={<img src={nodeJsIcon} alt="Swift Logo" className="w-6 h-6" width={100} />}
                  name={"Node Js"}
                  value={80}
                />
                <ProgressBar
                  logo={<img src={springbootIcon} alt="SpringBoot Logo" className="w-6 h-6" />}
                  name={"SpringBoot"}
                  value={95}
                />
            </div>
